...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        handheldItem(ModItems.TUENIUM_AXE.get());
        handheldItem(ModItems.TUENIUM_PICKAXE.get());
        ...
        trimmedArmorItem(ModItems.TUENIUM_BOOTS);
    }

    //Credit El_Redstoniano and Kaupenjoe
    private void trimmedArmorItem(DeferredItem<ArmorItem> itemDeferredItem) {
        final String MOD_ID = ExpFactory.MODID; // Change this to your mod id
    ...
    private ItemModelBuilder handheldItem(DeferredItem<?> item) {
        return withExistingParent(item.getId().getPath(),
                ...
                ResourceLocation.fromNamespaceAndPath(ExpFactory.MODID, "item/" + item.getId().getPath()));
    }
}
