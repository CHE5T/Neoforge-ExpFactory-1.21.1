...
public class ThermalBatteryScreen extends AbstractContainerScreen<ThermalBatteryMenu> {
    private static final ResourceLocation GUI_TEXTURE = ResourceLocation.fromNamespaceAndPath(ExpFactory.MODID, "textures/gui/thermal_battery/thermal_battery_gui.png");
    ...
    public ThermalBatteryScreen(ThermalBatteryMenu menu, Inventory playerInventory, Component title) {
