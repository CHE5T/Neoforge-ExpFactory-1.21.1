...
public class Capsule extends BaseEntityBlock {
    public static final VoxelShape SHAPE = Block.box(6.0, 0.0, 6.0, 10.0, 11.0, 10.0);
    public static final MapCodec<Capsule> CODEC = simpleCodec(Capsule::new);

    public Capsule(Properties properties) {
        super(properties);
    }
    ...
    public @Nullable BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new CapsuleEntity(pos, state);
    }
